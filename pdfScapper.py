...
# def assign_heading_level(text, font_size, sorted_unique_sizes, bold_ratio=0, y_position=None, page=None):
#     """
#     Assigns H1–H3 based on numeric prefix or fallback heuristic (font size, boldness, position).
#     """
#     text = text.strip()
...
#     if y_position is not None and y_position < 300 and page == 0:
#         score += 1
...
def extract_headings(pdf_path):
    ...
    # 6. Title from first H1 on page 0
    title = ''
    for o in outline:
        if o['level']=='H1' and o['page']==0 and not text_contains_exclusion_keywords(o['text']):
            title = o['text']
